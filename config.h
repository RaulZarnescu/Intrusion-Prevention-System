...
#define THREATS_INTEL_FILE "../inline_bpf/threats.txt"
#define SNI_BLOCKLIST_FILE "../inline_bpf/sni_blocklist.txt"
#define DOH_RESOLVER_BLOCKLIST_FILE "../inline_bpf/doh_resolvers.txt"
